...
function BookCard(props) {
    ...
    return (
        <div className="col col-lg-4 col-xl-3 col-md-6 col-sm-12 d-flex">
            <div className="card h-100 pt-3" style={{ width: "270px", minWidth: "270px" }}>
                ...
                <div className="card-footer">
                    <div className="d-flex justify-content-between">
                        <button className="btn btn-primary btn-sm d-inline-flex justify-content-center align-items-center" onClick={handleAddOrRemove}><img width="28px" src={cart[_id] ? removeCartIcon : addCartIcon} alt="cart-icon" /><span className='ms-2 fs-6'>{cart[_id] ? "Remove" : "Add"}</span></button>
                        <button className="btn btn-primary btn-sm d-inline-flex justify-content-center align-items-center"><img width="20px" src={buyIcon} alt="buy-icon" /><span className='ms-2 fs-6'>Buy Now</span></button>
                    </div>
                </div>
            </div>
        </div>
